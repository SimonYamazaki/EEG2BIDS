...
% kan der ligger mere end én .bdf fil i /eeg mappen?
% kan man ligge ASSR reg og ASSR irreg sammen? 
% kan man ligge flere tasks sammen i et bids_dir? 
% hvorfor er channels.json tom?
...
% skal både duration og start stop være med i ASSR events + MMN  - kun duration og onset. Onset for stimuli ikke epoch. skriv det i .json
...
% hvilken type channels er de external? status channel i channels.tsv??? - melissa undersøger
...
%       - split filerne op hvis muligt med en funktion
% Flanker træningsdata i /beh mappe? - det må godt komme med
% hvor meget skal i task instructions fra word filen? -bare selv tilføj noget så det giver mening 
