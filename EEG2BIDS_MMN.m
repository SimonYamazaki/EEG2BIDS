...
files_checked.via11 = {'*task-MMN_eeg.bdf','*task-MMN_eeg.json','*task-MMN_events.tsv','*task-MMN_channels.tsv'};
files_checked.via15 = {'*task-MMN_eeg.bdf','*task-MMN_eeg.json','*task-MMN_events.tsv','*task-MMN_channels.tsv'};
